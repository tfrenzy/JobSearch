  ...
  <tr>
   ...
   <td colspan="2" valign="top"><br />
	<table border="0" cellspacing="0" cellpadding="2" width="610">
        <tr>
          <td class="subHeader" colspan="2"><p style="margin-top: 0; margin-bottom: 0;">Check for Job Vacancy </p>
          </td>
        </tr>
        <tr>
          ...
          <td width="562" class="sidebarHeader"><form id="form1" name="form1" method="post" action="">
            ...
            <table width="709" border="1">
              ...
              <tr>
                <?php
				$sql2 = "SELECT * FROM `person` WHERE `Name` = '$_SESSION[user]'";
				$result2 = mysql_query($sql2);
				$category = mysql_result($result2, 0, "Name");
				
			  $sql = "SELECT * FROM `jobalert` WHERE `Qualification` = '$category'";
