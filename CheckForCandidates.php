          ...
          <td width="562" class="sidebarHeader"><form id="form1" name="form1" method="post" action="">
            ...
            <table width="870" border="1">
              <tr>
                ...
                <td width="337">Description</td>
                <td width="337">Select job</td>
                </tr>
              <tr>
                <td>&nbsp;</td>
                <td>&nbsp;</td>
              ...
              <tr>
                <td colspan="3" align="center"><input type="submit" name="button" id="button" value="Remove selected vacancies" /></td>
                </tr>
            </table>
            <p>&nbsp;</p>
          </form>
