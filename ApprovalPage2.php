  ...
  <tr>
   ...
   <td colspan="2" valign="top"><br />
	<table border="0" cellspacing="0" cellpadding="2" width="610">
        <tr>
          <td class="subHeader" colspan="2"><p style="margin-top: 0; margin-bottom: 0;">Approve Companies </p>
          </td>
        </tr>
        <tr>
          ...
          if (isset($_POST['button'])) {
           $sql = "SELECT * FROM `company` WHERE `Status` = 'Not verified'";
			  $result = mysql_query($sql);
			  for ($r = 0; $r <= mysql_num_rows($result)-1; $r++) {
				  $name = mysql_result($result, $r, "Name");
				  $check = "check$r";
			  if ($_POST['$check'] == "Yes") {
			$sql2 = "UPDATE `company` SET `Status` = 'Verified' WHERE `NameOfCompany` = '$name'";
          ...
          ?>
            ...
            <table width="709" border="1">
			  ...
			  for ($r = 0; $r <= mysql_num_rows($result)-1; $r++) {
			?>
                <td><?php echo mysql_result($result, $r, "NameOfCompany"); ?></td>
                <td><?php echo mysql_result($result, $r, "Address"); ?></td>
              ...
              <tr>
                <td colspan="3" align="center"><input type="submit" name="button" id="button" value="Approve selected companies" /></td>
              </tr>
            </table>
<p>&nbsp;</p>
          </form>
